        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ flexGrow: 1, paddingBottom: 40 }}>
            ...
            >
              ...
              <View style={styles.templateInfo}>
                ...
                <Text style={[styles.templateDetails, { color: colors.textSecondary }]}>
                  {selectedTemplate.defaultFormat.toUpperCase()} • {selectedTemplate.defaultSampleRate/1000}kHz • {selectedTemplate.defaultBitrate}kbps
                </Text>
              </View>
          ...
          <View style={styles.recordingSection}>
            ...
            <Animated.View style={{ transform: [{ scale: pulseAnim }] }}>
              <TouchableOpacity
                style={[styles.recordingButton, { backgroundColor: isRecording ? colors.error : colors.primary, shadowColor: colors.text, shadowOpacity: 0.2, shadowRadius: 12, elevation: 12 }]}
            ...
            <Text style={[styles.recordingStatus, { color: colors.textSecondary }]}>
              {isRecording ? (isPaused ? "⏸️ Paused" : "🔴 Recording...") : "🎤 Tap to start"}
            </Text>
                  ...
                  >
                    ...
                    <View style={styles.templateOptionInfo}>
                      ...
                      <Text style={[styles.templateOptionDetails, { 
                        ...
                        {template.defaultFormat.toUpperCase()} • {template.defaultSampleRate/1000}kHz • {template.defaultBitrate}kbps
                      </Text>
                    </View>
