...
const HomeScreen = () => {
  ...
  const quickStats = [
    ...
    { label: "Tasks", count: 8, icon: "checkbox-outline", color: "#10B981", gradient: ["#10B981", "#059669"] },
    { label: "Recordings", count: 5, icon: "mic-outline", color: "#F59E0B", gradient: ["#F59E0B", "#D97706"] },
  ]
            ...
            {recentNotes.length > 0 ? (
                ...
                >
                  ...
                  <View style={styles.itemContent}>
                    ...
                    <View style={styles.itemMeta}>
                      <Text style={[styles.itemDate, { color: colors.textDim }]} className="font-[Inter]">
                        {item.date}
                      </Text>
                      <View style={[styles.itemType, { backgroundColor: colors.primary }]}>
                        <Text style={styles.itemTypeText} className="font-[InterMedium]">
                          Note
                        </Text>
                      </View>
                    </View>
              ...
              <View style={[styles.emptyState, { backgroundColor: colors.surface }]}>
                ...
                <TouchableOpacity 
                  ...
                  onPress={() => router.push('/note-detail?action=new')}
                >
...
const styles = StyleSheet.create({
  ...
  statCard: {
    ...
    paddingVertical: 20,
    borderRadius: 20,
    backgroundColor: '#050a12', // Much darker shade for better visibility
    borderWidth: 1,
    borderColor: '#1a2332', // Subtle border to define edges
    shadowColor: "#000",
